...
class FilterPurchaseReport(StoredProcedureTestCase):
    ...
    def test_view_purchase_report(self):
        ...
        self.assertEqual(filteredPurchaseReport[0]["product_category"],
                            productCategory1["category"],
                            "Product category mismatch")
        self.assertEqual(filteredPurchaseReport[0]["product_id"],
                            product2["product_id"],
                            "Product ID mismatch")
        self.assertEqual(filteredPurchaseReport[0]["product"],
                            product2["product"],
                            "Product mismatch")
        ...
        self.assertEqual(filteredPurchaseReport[1]["product_category_id"],
                            productCategory1["product_category_id"],
                            "Product category ID mismatch")
        self.assertEqual(filteredPurchaseReport[1]["product_category"],
                            productCategory1["category"],
                            "Product category mismatch")
        self.assertEqual(filteredPurchaseReport[1]["product_id"],
                            product1["product_id"],
                            "Product ID mismatch")
        self.assertEqual(filteredPurchaseReport[1]["product"],
                            product1["product"],
                            "Product mismatch")
...
def filter_purchase_report(db, filterColumn, filterText, sortColumn, sortOrder, fromDate, toDate):
    db.call_procedure("FilterPurchaseReport", [filterColumn,
                                                filterText,
                                                sortColumn,
                                                sortOrder,
                                                fromDate,
