...
class FilterProductCategoriesByProduct(StoredProcedureTestCase):
    @unittest.skip("Needs to be refactored.")
    def test_filter_product_categories_by_product(self):
        ...
        fetchedProductCategories = filter_product_categories(db=self.db,
                                                                filterText="ya",
                                                                sortOrder="ascending")
...
def filter_product_categories(db, filterText, sortOrder=None):
    db.call_procedure("FilterProductCategories", [filterText, sortOrder])
    results = []
    for row in db:
        result = {
            "product_category_id": row["product_category_id"],
